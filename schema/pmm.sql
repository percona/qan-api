...
CREATE TABLE IF NOT EXISTS query_global_metrics (
  ...
  Rows_examined_sum    INT UNSIGNED,
  ...
  Rows_affected_sum             INT UNSIGNED,
  ...
  InnoDB_IO_r_ops_sum           INT UNSIGNED,
  ...
  InnoDB_IO_r_bytes_sum         INT UNSIGNED,
  ...
  InnoDB_pages_distinct_sum     INT UNSIGNED,
  ...
  Tmp_disk_tables_sum           INT UNSIGNED,
  ...
  -- Performance Schema
  Errors_sum                    INT UNSIGNED,
  Warnings_sum                  INT UNSIGNED,
  Select_full_range_join_sum    INT UNSIGNED,
  Select_range_sum              INT UNSIGNED,
  Select_range_check_sum        INT UNSIGNED,
  Sort_range_sum                INT UNSIGNED,
  Sort_rows_sum                 INT UNSIGNED,
  Sort_scan_sum                 INT UNSIGNED,
  No_index_used_sum             INT UNSIGNED,
  No_good_index_used_sum        INT UNSIGNED,
  --
